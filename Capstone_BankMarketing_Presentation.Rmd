...
A Portuguese bank uses telemarketing campaigns to engage their customers. Each 
customer engagement has been recorded for evaluation. Such data can be used to 
extract insights for making better campaign decisions.

Marketing campaigns generally do not discriminate how customers are targeted.
Therefore, some campaigns are irrelevant to some customers and unneccessary  
resources may be spent on customers that lead to rejection. 


## Motivation

The Bank has asked me to work on this classification problem, which has 2 
goals:

* Predict whether a customer will subscribe to a term deposit.
* Predict the probability of a successful subscriptions.
...
The following two Machine Learning models were used to predict subscriptions:
