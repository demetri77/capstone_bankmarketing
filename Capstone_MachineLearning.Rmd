...
Review the confusion matrix for the logistic regression model. Take note 
because this data set is highly skewed, the accuracy value becomes 
impractical. As such, the Kappa value will be noted. 
